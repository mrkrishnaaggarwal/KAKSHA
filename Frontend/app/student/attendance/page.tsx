...
export default function AttendancePage() {
  ...
  return (
    <div className="flex-1 bg-gray-50 p-1 md:p-2 lg:p-4 overflow-auto">
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
          {/* Page Header */}
          <div className="bg-gradient-to-r from-[#6A2CFF] to-blue-500 p-6 lg:p-7">
          ...
          {error && (
            <div className="bg-red-50 border-l-4 border-red-500 text-red-700 p-6 m-8 rounded-lg shadow-sm">
              <div className="flex items-center">
                <svg className="h-7 w-7 text-red-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {!loading && !error && (
            <div className="md:flex">
                        ...
                        {dayAttendance.length > 0 ? (
                          ...
                          <div className="text-center py-10 px-4 bg-gray-50 rounded-lg border border-gray-200">
                            <div className="mx-auto w-14 h-14 flex items-center justify-center rounded-full bg-gray-100 mb-4">
                              <AiOutlineCalendar className="text-gray-400" size={28} />
                            </div>
              ...
              <div className="md:w-[55%] p-6 lg:p-8">
                <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                  <AiOutlineBook className="mr-2" size={20} />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                      ...
                      >
                        <div className="p-4 lg:p-5">
                          ...
                          <div className="flex justify-between items-start">
                            <h4 className="font-medium text-lg text-gray-800">{subject.subject}</h4>
                          ...
                          <div className="flex items-center text-sm text-gray-500 my-3">
                            <svg className="w-4 h-4 mr-1.5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            <span>
                              {subject.present_count} of {subject.total_classes} classes attended
                            </span>
                          </div>
                  ...
                  {subjectAttendance.length === 0 && (
                    <div className="col-span-1 sm:col-span-2 lg:col-span-2 text-center py-12 px-4 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <p className="text-gray-500 font-medium text-lg">No attendance statistics available</p>
                      <p className="text-gray-400 mt-2">Your attendance records will appear here once available</p>
                    </div>
                  )}
                </div>
                ...
                {subjectAttendance.length > 0 && (
                  ...
                  >
                    <h4 className="text-gray-800 font-medium text-lg mb-3">Overall Summary</h4>
                    ...
                    {(() => {
                      ...
                      const colorClass = getAttendanceColorClass(overallPercentage);
                        ...
                        <>
                          ...
                          <p className="text-base mt-2">
                            {overallPercentage >= 75 ? (
                              <span className="text-green-700">You're maintaining good attendance across all subjects.</span>
                            ) : overallPercentage >= 60 ? (
                              <span className="text-yellow-700">Your attendance needs improvement in some subjects.</span>
                            ) : (
                              <span className="text-red-700">Your attendance is below required levels. Please improve.</span>
                            )}
                          </p>
                        </>
                      );
